...
- [Definitions | 定义](#definitions)
	- [OpenAPI Document | OpenAPI 文档](#oasDocument)
	- [Path Templating | 路径模板](#pathTemplating)
	- [Media Types | 媒体类型](#mediaTypes)
	- [HTTP Status Codes | HTTP 状态码](#httpCodes)
- [Specification | 规范](#specification)
	- [Versions | 版本](#versions)
	- [Format | 格式](#format)
	- [Document Structure | 文档结构](#documentStructure)
	- [Data Types | 数据类型](#dataTypes)
	- [Rich Text Formatting | 富文本格式](#richText)
	- [Relative References In URLs | 相对引用](#relativeReferences)
	- [Schema | 纲要](#schema)
		- [OpenAPI Object | OpenAPI 对象](#oasObject)
		- [Info Object | Info 对象](#infoObject)
		- [Contact Object | Contact 对象](#contactObject)
		- [License Object | License 对象](#licenseObject)
...
## <a name="definitions"></a>Definitions | 术语定义

##### <a name="oasDocument"></a>OpenAPI Document | Open API 文档
...
### <a name="documentStructure"></a>Document Structure | 文档结构
